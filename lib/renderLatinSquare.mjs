import { validateLatinSquare } from './solveLatinSquare.mjs?v=20260808-4';
...
export function renderLatinSquare(question) {
  ...
  // Find the "?" cell specifically (matching the solver logic)
  ...
  // If no "?" cell found, fall back to first null cell
